...
const permissionTooltipBySlug = {
  ...
  ver_reportes_mantencion: "Permite ver el resumen ejecutivo y los reportes operativos de Mantención, incluida la carga de trabajo.",
  exportar_mantencion: "Permite exportar los informes de Mantención en Excel y PDF.",
