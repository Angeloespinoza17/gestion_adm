...
<template>
  <Layout>
    <PageHeader title="Basic Tables" pageTitle="Tables" />
    <BRow>
      <BCol xl="6">
        <BCard no-body>
    ...
    <BRow>
      <BCol xl="12">
        <BCard no-body>
          <BCardBody>
            <BCardTitle>Striped columns</BCardTitle>
            <p class="card-title-desc">
              Use <code>.table-striped-columns</code> to add zebra-striping to any table column.
            </p>

            <div class="table-responsive">
              <BTableSimple class="table-striped-columns mb-0">
                <BThead>
                  <BTr>
                    <BTh>#</BTh>
                    <BTh>First Name</BTh>
    ...
    <BRow>
      <BCol xl="6">
        <BCard no-body>
          <BCardBody class="pb-0">
            <BCardTitle>Table Border color</BCardTitle>
            ...
            <div class="table-responsive">
              <BTableSimple class="table-bordered border-primary mb-0">
                <BThead>
                  <BTr>
                    <BTh>#</BTh>
                    <BTh>First Name</BTh>
      ...
      <BCol xl="6">
        <BCard no-body>
          <BCardBody class="pb-0">
            ...
            <div class="table-responsive">
              <BTableSimple class="table-bordered border-success mb-0">
                <BThead>
                  <BTr>
                    <BTh>#</BTh>
                    <BTh>First Name</BTh>
    ...
    <BRow>
      <BCol xl="6">
        <BCard no-body>
          <BCardBody class="pb-0">
            <div class="table-responsive">
              <BCardTitle>Vertical alignment</BCardTitle>
                ...
                <BTableSimple class="align-middle mb-0">
                  ...
                  <BTbody>
                    <BTr>
                      ...
                      <BTd>Otto</BTd>
                      <BTd>
                        <BButton variant="light" type="button" class="btn-sm">
                          View
                        </BButton>
                      </BTd>
                    </BTr>
      ...
      <BCol xl="6">
        <BCard no-body>
          <BCardBody class="pb-0">
            ...
            <div class="table-responsive">
              <BTableSimple class="table-striped table-bordered mb-0">
                <BThead>
                  <BTr>
                    <BTh scope="col">#</BTh>
                    <BTh scope="col">First</BTh>
                    <BTh scope="col">Last</BTh>
                    <BTh scope="col">Handle</BTh>
                  </BTr>
                </BThead>
                <BTbody>
                  <BTr>
