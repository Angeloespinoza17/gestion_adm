...
<template>
  <Layout>
    <PageHeader title="Typography" pageTitle="UI Elements" />
    ...
    <BRow>
      <BCol xl="6">
        ...
        <BCard no-body>
          <BCardBody>
            ...
            <BCardTitle>Headings</BCardTitle>
      ...
      <BCol xl="6">
        <BCard no-body>
          <BCardBody>
            <BCardTitle>Display headings</BCardTitle>
            <p class="card-title-desc">Traditional heading elements are designed to work best in the meat of your page
              content.</p>
    ...
    <BRow>
      <BCol xl="6">
        <BCard no-body>
          <BCardBody>
            <BCardTitle>Inline text elements</BCardTitle>
      ...
      <BCol xl="6">
        <BCard no-body>
          <BCardBody>
            <BCardTitle>Unstyled List</BCardTitle>
            <p class="card-title-desc">
              Remove the default <code class="highlighter-rouge">list-style</code> and left
        ...
        <BCard no-body class="mt-4">
          <BCardBody>
            <BCardTitle>Inline List</BCardTitle>
            <p class="card-title-desc">
              Remove a list’s bullets and apply some light <code class="highlighter-rouge">margin</code> with a
              combination
    ...
    <BRow>
      <BCol lg="12">
        <BCard no-body>
          <BCardBody>
            <BCardTitle>Blockquotes</BCardTitle>
            <p class="card-title-desc">
    ...
    <BRow>
      <BCol cols="12">
        <BCard no-body>
          <BCardBody>
            <BCardTitle>Description list alignment</BCardTitle>
            <p class="card-title-desc">
    ...
    <BRow>
      <BCol lg="6">
        <BCard no-body>
          <BCardBody>
            <BCardTitle>Text transform</BCardTitle>
            <p class="card-title-desc">
              Use <code>.text-lowercase</code>, <code>.text-uppercase</code>, or <code>.text-capitalize</code> to
              transform the text.
            </p>
      ...
      <BCol lg="6">
        <BCard no-body>
          <BCardBody>
            <BCardTitle>Text decoration</BCardTitle>
            <p class="card-title-desc">
    ...
    <BRow>
      <BCol lg="6">
        <BCard no-body>
          <BCardBody>
            <BCardTitle>Font size</BCardTitle>
      ...
      <BCol lg="6">
        <BCard no-body>
          <BCardBody>
            <BCardTitle>Text wrapping and overflow</BCardTitle>
        ...
        <BCard no-body class="mt-4">
          <BCardBody>
            <BCardTitle>Word break</BCardTitle>
            <p class="card-title-desc">
              Use <code>text-break</code> class to prevent long strings of text from breaking your components' layout.
            </p>
            <div>
    ...
    <BRow>
      <BCol lg="6">
        <BCard no-body>
          <BCardBody>
            <BCardTitle>Font weight and italics</BCardTitle>
            <p class="card-title-desc">
              <code>font-style</code> utilities are abbreviated as <code>.fst-*</code> and
              <code>font-weight</code> utilities are abbreviated as <code>.fw-*</code>.
            </p>
            <div>
      ...
      <BCol lg="6">
        <BCard no-body>
          <BCardBody>
            <BCardTitle>Line height</BCardTitle>
            <p class="card-title-desc">Use line-height utility classes to control spacing between lines of text.</p>
            <div>
