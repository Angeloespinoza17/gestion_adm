  ...
  <section class="matrix-card">
    ...
    <div class="table-responsive">
      <table class="table table-hover align-middle mb-0">
        <thead><tr><th>Alumna</th><th>Curso</th><th>JUNAEB</th><th>Pro Retención</th><th>Otro programa</th><th>SEP</th><th>Protección / PIE</th><th>Alerta médica</th><th></th></tr></thead>
        <tbody>
          ...
          <tr v-if="!students.length && !api.loading"><td colspan="9" class="empty">No hay alumnas para los filtros seleccionados.</td></tr>
        </tbody>
      </table>
    </div>
