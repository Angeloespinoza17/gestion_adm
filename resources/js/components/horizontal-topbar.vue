...
import flagFrench from "@/assets/images/flags/french.jpg";
...
export default {
  ...
  mounted() {
    if (import.meta.env.VITE_APP_I18N_LOCALE) {
      this.flag = this.$i18n.locale || import.meta.env.VITE_APP_I18N_LOCALE;
  ...
  <header id="page-topbar" class="floating-navbar">
    <div class="navbar-header">
      ...
      <div class="d-flex">
        ...
        <BDropdown variant="white" class="d-flex d-inline-block align-center" menu-class="dropdown-menu-end"
        ...
        <BDropdown class="d-none d-lg-inline-block noti-icon" menu-class="dropdown-menu-lg dropdown-menu-end" right
