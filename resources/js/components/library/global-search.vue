...
import { formatLibraryError } from "./module-utils";
...
export default {
  ...
  methods: {
    ...
    async search() {
      ...
      this.loading = true;
      try {
        const response = await axios.get("/api/biblioteca/search", {
          params: { q: this.query },
        });
        this.results = response.data.data || [];
        this.showDropdown = true;
      } catch (error) {
        this.error = formatLibraryError(error, "No se pudo ejecutar el buscador global.");
      } finally {
        this.loading = false;
      }
    },
  ...
  <div class="position-relative">
    <div class="input-group">
      ...
      <BFormInput
        ...
        placeholder="Buscar título, autor, ISBN, código, estudiante, funcionario o curso"
