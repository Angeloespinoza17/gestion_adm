...
class PermissionBackfillSeeder extends Seeder
{
    ...
    private function permissions(): array
    {
        return [
            ...
            ['slug' => 'contabilidad.ejecucion_presupuestaria.ver', 'name' => 'Ver ejecucion presupuestaria', 'description' => 'Permite consultar la ejecucion presupuestaria anual.'],
            ['slug' => 'contabilidad.ejecucion_presupuestaria.importar', 'name' => 'Importar ejecucion presupuestaria', 'description' => 'Permite cargar y reemplazar archivos de ejecucion presupuestaria.'],
            ['slug' => 'contabilidad.ejecucion_presupuestaria.exportar', 'name' => 'Exportar ejecucion presupuestaria', 'description' => 'Permite exportar el informe PDF de ejecucion presupuestaria.'],
