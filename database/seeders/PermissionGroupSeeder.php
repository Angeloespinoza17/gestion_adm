...
class PermissionGroupSeeder extends Seeder
{
    ...
    public static function definitions(): array
    {
        return [
            ...
            [
                'slug' => 'comite_paritario',
                'module_slug' => 'risk_prevention_joint_committee',
                'name' => 'Comité Paritario',
                'description' => 'Consulta del Comité Paritario y carga de actas mensuales o de constitución.',
                'sort_order' => 133,
                'permissions' => [
            ...
            [
                'slug' => 'entregas_epp_bodega',
                'module_slug' => 'inventory_epp_deliveries',
                'name' => 'Entrega diaria de EPP',
                'description' => 'Consulta y registro de entregas de EPP vinculadas al stock de Bodega.',
                'sort_order' => 134,
                'permissions' => [
                    'ver_entregas_epp',
            ...
            [
                ...
                'name' => 'Mantencion',
                'description' => 'Resumen ejecutivo, reportes, ordenes de trabajo, visitas, carga de trabajo y plan anual de mantencion.',
                'sort_order' => 140,
                'permissions' => [
                    'ver_mantencion',
                    'crear_ot',
            ...
            [
                ...
                'name' => 'Abastecimiento',
                'description' => 'Catálogo, compras, stock, entregas, solicitudes y actas de insumos institucionales.',
                'sort_order' => 145,
                'permissions' => [
                    'ver_abastecimiento',
                    ...
                    'ver_solicitudes_abastecimiento',
                    'crear_solicitudes_abastecimiento',
                ],
            ],
            [
                'slug' => 'inventario',
            ...
            [
                ...
                'module_slug' => 'pedagogical_management',
                'name' => 'Gestión pedagógica',
                'description' => 'Envío, revisión humana, rectificaciones, apoyo IA opcional y derivación privada de instrumentos pedagógicos en PDF.',
                'sort_order' => 245,
                'permissions' => [
                    ...
                    'class-presentations.create',
                    'class-presentations.download',
                    'class-presentations.regenerate',
                    'class-presentations.archive',
                ],
            ],
            [
                'slug' => 'remuneraciones',
