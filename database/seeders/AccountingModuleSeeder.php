...
class AccountingModuleSeeder extends ModuleSeeder
{
    ...
    private function seedPermissionsAndModules(): void
    {
        ...
        $children = [
            ...
            ['slug' => 'accounting_budget_execution', 'name' => 'Ejecución presupuestaria', 'route' => '/contabilidad/ejecucion-presupuestaria', 'sort' => 4],
            ['slug' => 'accounting_cost_centers', 'name' => 'Centros de costo', 'route' => '/contabilidad/centros-costo', 'sort' => 5],
            ['slug' => 'accounting_manual', 'name' => 'Manual de cuentas', 'route' => '/contabilidad/manual-cuentas', 'sort' => 6],
            ['slug' => 'accounting_incomes', 'name' => 'Ingresos', 'route' => '/contabilidad/ingresos', 'sort' => 7],
            ['slug' => 'accounting_expenses', 'name' => 'Egresos / pagos', 'route' => '/contabilidad/egresos', 'sort' => 8],
            ['slug' => 'accounting_cash_funds', 'name' => 'Caja chica', 'route' => '/contabilidad/caja-chica', 'sort' => 9],
            ['slug' => 'accounting_funds_to_render', 'name' => 'Fondos por rendir', 'route' => '/contabilidad/fondos-rendir', 'sort' => 10],
            ['slug' => 'accounting_reconciliation', 'name' => 'Conciliación bancaria', 'route' => '/contabilidad/conciliacion', 'sort' => 11],
            ['slug' => 'accounting_subsidies', 'name' => 'Subvenciones', 'route' => '/contabilidad/subvenciones', 'sort' => 12],
            ['slug' => 'accounting_cheques', 'name' => 'Cheques', 'route' => '/contabilidad/cheques', 'sort' => 13],
            ['slug' => 'accounting_invoices', 'name' => 'Facturas', 'route' => '/contabilidad/facturas', 'sort' => 14],
            ['slug' => 'accounting_honoraries', 'name' => 'Boletas de honorarios', 'route' => '/contabilidad/boletas-honorarios', 'sort' => 15],
            ['slug' => 'accounting_cashflow', 'name' => 'Flujo de caja', 'route' => '/contabilidad/flujo-caja', 'sort' => 16],
            ['slug' => 'accounting_payables', 'name' => 'Cuentas por pagar', 'route' => '/contabilidad/cuentas-por-pagar', 'sort' => 17],
            ['slug' => 'accounting_f29', 'name' => 'Gestión F29', 'route' => '/contabilidad/f29', 'sort' => 18],
            ['slug' => 'accounting_balance', 'name' => 'Balance 8 y 9 columnas', 'route' => '/contabilidad/balance', 'sort' => 19],
            ['slug' => 'accounting_dj_income', 'name' => 'DJ Ingresos', 'route' => '/contabilidad/dj-ingresos', 'sort' => 20],
            ['slug' => 'accounting_dj_rental', 'name' => 'DJ Arriendo', 'route' => '/contabilidad/dj-arriendo', 'sort' => 21],
            ['slug' => 'accounting_income_tax', 'name' => 'Declaración de Renta', 'route' => '/contabilidad/declaracion-renta', 'sort' => 22],
            ['slug' => 'accounting_reports', 'name' => 'Reportes', 'route' => '/contabilidad/reportes', 'sort' => 23],
        ];
    ...
    private function seedRoles(): void
    {
        ...
        $rolePermissions = [
            ...
            'contabilidad_analista' => array_values(array_unique(array_merge($confidentialBaseView, [
                ...
                AccountingAccessService::SUBSIDY_APPROVE_PERMISSION,
