...
class RbacSeeder extends Seeder
{
    ...
    private function seedPermissions(): void
    {
        $permissions = [
            ...
            ['slug' => 'ver_enfermeria', 'name' => 'Ver módulo de Enfermería'],
            ['slug' => 'ver_psicologia', 'name' => 'Ver Psicología'],
            ['slug' => 'ver_convivencia', 'name' => 'Ver Convivencia Escolar'],
            ['slug' => 'ver_dashboard_convivencia', 'name' => 'Ver dashboard de Convivencia Escolar'],
            ['slug' => 'ver_casos_convivencia', 'name' => 'Ver casos de Convivencia Escolar'],
            ...
            ['slug' => 'superadmin.logbooks.view', 'name' => 'Ver consolidado institucional de bitácoras'],
    ...
    private function seedRolesAndAssignments(): void
    {
        $roles = [
            ...
            ['slug' => 'subdirector', 'name' => 'Subdirector', 'description' => 'Supervisión institucional de convivencia, apoyo psicosocial, operación, pedagogía, salud y servicios escolares.'],
            ...
            ['slug' => 'encargado_web', 'name' => 'Encargado Web', 'description' => 'Gestión y publicación de contenidos del sitio web institucional.'],
        ...
        // Encargado Web
        $rolesBySlug['encargado_web']->permissions()->sync($this->ids($permissionsBySlug, [
            'ver_metricas_sitio',
            'ver_noticias',
            'gestionar_noticias',
            'ver_eventos',
        ...
        $rolesBySlug['encargado_web']->modules()->sync($this->ids($modulesBySlug, [
            'public_site',
            'public_site_analytics',
            'public_site_news',
            'public_site_events',
