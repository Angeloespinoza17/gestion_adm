...
class RbacSeeder extends Seeder
{
    ...
    private function seedModules(): void
    {
        $modules = [
            ...
            ['slug' => 'schedule', 'name' => 'Horarios docentes', 'frontend_route' => null, 'icon' => 'bx-calendar-week', 'sort' => 23],
            ...
            ['slug' => 'porter', 'name' => 'Portería', 'frontend_route' => null, 'icon' => 'bx-door-open', 'sort' => 25],
            ...
            ['slug' => 'maintenance_dependencies', 'name' => 'Activos técnicos', 'frontend_route' => '/maintenance/dependencies', 'icon' => null, 'sort' => 1, 'parent' => 'maintenance'],
