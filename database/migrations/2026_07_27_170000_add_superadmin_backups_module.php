...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::table('system_modules')->insertOrIgnore([
            'slug' => 'settings_backups',
            'name' => 'Respaldos',
            'frontend_route' => '/admin/backups',
            'icon' => null,
            'sort_order' => 8,
            'active' => true,
        ...
        $moduleId = DB::table('system_modules')->where('slug', 'settings_backups')->value('id');
    ...
    {
        // Módulo aditivo: no se eliminan asignaciones ni metadatos RBAC.
    }
};
