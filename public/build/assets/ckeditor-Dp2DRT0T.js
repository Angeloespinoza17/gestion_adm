import{u as y,aJ as C,aU as p,af as D,a3 as T,ad as _,aj as k,k as N,aw as O,a4 as v,aq as d,aT as E}from"../js/app-CTYivQkW.js";import{d as K}from"./main-B88lsrjp.js";/**
 ...
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md.
 */function w(e){return e?["nightly","alpha","internal"].some(t=>e.includes(t)):!1}function B(e){return I(e)||w(e)}/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md.
 ...
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md.
 */function U(e){if(w(e))return 3;const{major:t}=P(e);switch(!0){case t>=44:return 3;case t>=38:return 2;default:return 1}}/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md.
 */function S(){const{CKEDITOR_VERSION:e,CKEDITOR:t}=window;return B(e)?{source:t?"cdn":"npm",version:e}:null}/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md.
 */function j(){const e=S();return e?U(e.version):null}/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md.
 */function h(e,t){switch(t||(t=j()||void 0),t){case 1:case 2:return e===void 0;case 3:return e==="GPL";default:return!1}}/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md.
 */function L(e,t){return function(a){h(a.config.get("licenseKey"))||a.on("collectUsageData",(u,{setUsageData:i})=>{i(`integration.${e}`,t)})}}/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md.
 */const x=L("vue",{version:"7.3.0",frameworkVersion:E});/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md.
 */function M(e){return h(e.licenseKey)?e:R(e,[x])}const f="Lock from Vue integration (@ckeditor/ckeditor5-vue)",A=300,q=y({name:"CKEditor",__name:"ckeditor",props:v({editor:{},config:{default:()=>({})},tagName:{default:"div"},disabled:{type:Boolean,default:!1},disableTwoWayDataBinding:{type:Boolean,default:!1}},{modelValue:{type:String,default:""},modelModifiers:{}}),emits:v(["ready","destroy","blur","focus","input","update:modelValue"],["update:modelValue"]),setup(e,{expose:t,emit:s}){const a=C(e,"modelValue"),u=e,i=s,m=d(),r=d(),c=d();t({instance:r,lastEditorData:c}),p(a,n=>{r.value&&n!==c.value&&r.value.data.set(n)}),p(()=>u.disabled,n=>{n?r.value.enableReadOnlyMode(f):r.value.disableReadOnlyMode(f)});function b(){const n=window.CKEDITOR_VERSION;if(!n)return console.warn('Cannot find the "CKEDITOR_VERSION" in the "window" scope.');const[o]=n.split(".").map(Number);o>=42||n.startsWith("0.0.0")||console.warn("The <CKEditor> component requires using CKEditor 5 in version 42+ or nightly build.")}function V(n){const o=K(l=>{if(u.disableTwoWayDataBinding)return;const g=c.value=n.data.get();i("update:modelValue",g,l,n),i("input",g,l,n)},A,{leading:!0});n.model.document.on("change:data",o),n.editing.view.document.on("focus",l=>{i("focus",l,n)}),n.editing.view.document.on("blur",l=>{i("blur",l,n)})}return b(),D(()=>{const n=M(Object.assign({},u.config));a.value&&(n.initialData=a.value),u.editor.create(m.value,n).then(o=>{r.value=T(o),V(o),a.value!==n.initialData&&o.data.set(a.value),u.disabled&&o.enableReadOnlyMode(f),i("ready",o)}).catch(o=>{console.error(o)})}),_(()=>{r.value&&(r.value.destroy(),r.value=void 0),i("destroy")}),(n,o)=>(k(),N(O(n.tagName),{ref_key:"element",ref:m},null,512))}});/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md.
