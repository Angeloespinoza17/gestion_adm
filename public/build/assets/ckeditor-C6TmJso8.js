import{r as y,aA as C,aL as p,a7 as D,X as _,a5 as T,ab as k,i as K,ao as N,Y as v,ai as d,aK as E}from"../js/app-BhKUBuaa.js";import{d as O}from"./main-BfLu-izo.js";/**
 ...
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md.
 */function L(){const{CKEDITOR_VERSION:e,CKEDITOR:t}=window;return B(e)?{source:t?"cdn":"npm",version:e}:null}/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md.
 */function S(){const e=L();return e?U(e.version):null}/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md.
 */function w(e,t){switch(t||(t=S()||void 0),t){case 1:case 2:return e===void 0;case 3:return e==="GPL";default:return!1}}/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md.
 ...
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md.
 */function A(e){return w(e.licenseKey)?e:R(e,[x])}const f="Lock from Vue integration (@ckeditor/ckeditor5-vue)",M=300,G=y({name:"CKEditor",__name:"ckeditor",props:v({editor:{},config:{default:()=>({})},tagName:{default:"div"},disabled:{type:Boolean,default:!1},disableTwoWayDataBinding:{type:Boolean,default:!1}},{modelValue:{type:String,default:""},modelModifiers:{}}),emits:v(["ready","destroy","blur","focus","input","update:modelValue"],["update:modelValue"]),setup(e,{expose:t,emit:s}){const a=C(e,"modelValue"),u=e,i=s,m=d(),r=d(),c=d();t({instance:r,lastEditorData:c}),p(a,n=>{r.value&&n!==c.value&&r.value.data.set(n)}),p(()=>u.disabled,n=>{n?r.value.enableReadOnlyMode(f):r.value.disableReadOnlyMode(f)});function b(){const n=window.CKEDITOR_VERSION;if(!n)return console.warn('Cannot find the "CKEDITOR_VERSION" in the "window" scope.');const[o]=n.split(".").map(Number);o>=42||n.startsWith("0.0.0")||console.warn("The <CKEditor> component requires using CKEditor 5 in version 42+ or nightly build.")}function V(n){const o=O(l=>{if(u.disableTwoWayDataBinding)return;const g=c.value=n.data.get();i("update:modelValue",g,l,n),i("input",g,l,n)},M,{leading:!0});n.model.document.on("change:data",o),n.editing.view.document.on("focus",l=>{i("focus",l,n)}),n.editing.view.document.on("blur",l=>{i("blur",l,n)})}return b(),D(()=>{const n=A(Object.assign({},u.config));a.value&&(n.initialData=a.value),u.editor.create(m.value,n).then(o=>{r.value=_(o),V(o),a.value!==n.initialData&&o.data.set(a.value),u.disabled&&o.enableReadOnlyMode(f),i("ready",o)}).catch(o=>{console.error(o)})}),T(()=>{r.value&&(r.value.destroy(),r.value=void 0),i("destroy")}),(n,o)=>(k(),K(N(n.tagName),{ref_key:"element",ref:m},null,512))}});/**
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md.
 *//* istanbul ignore if -- @preserve */if(!E.startsWith("3."))throw new Error("The CKEditor plugin works only with Vue 3+. For more information, please refer to https://ckeditor.com/docs/ckeditor5/latest/builds/guides/integration/frameworks/vuejs-v3.html");export{G as _};
