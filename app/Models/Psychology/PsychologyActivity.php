...
class PsychologyActivity extends Model
{
    ...
    protected $fillable = ['case_id', 'responsible_user_id', 'type', 'interview_number', 'activity_on', 'starts_at', 'ends_at', 'modality', 'location', 'participants', 'participant_types', 'interviewee_type', 'interviewee_name', 'interviewee_rut', 'interviewer_name_snapshot', 'interviewer_position_snapshot', 'objective', 'institutional_summary', 'private_note', 'general_background', 'result', 'agreements', 'next_steps', 'next_action_on', 'follow_up_type', 'next_interview_at', 'acknowledgement_status', 'acknowledged_name', 'acknowledged_rut', 'acknowledged_at', 'acknowledgement_observations', 'attendance_status', 'visibility', 'referral_feedback', 'status', 'finalized_at', 'finalized_by', 'created_by', 'updated_by'];
    ...
    {
        return $this->hasMany(PsychologyCoordinationRequest::class, 'activity_id');
    }
}
