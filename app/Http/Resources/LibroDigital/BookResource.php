    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'course' => $this->whenLoaded('courseSection', fn () => [
                ...
                'education_level_id' => $this->courseSection?->education_level_id,
                'education_type' => $this->courseSection?->educationLevel?->type ?? $this->level_code,
            ]),
            'subject' => $group?->relationLoaded('subject') ? [
                'id' => $group->subject?->id,
                'name' => $group->subject?->resolvedDisplayName(),
                'technical_name' => $group->subject?->name,
