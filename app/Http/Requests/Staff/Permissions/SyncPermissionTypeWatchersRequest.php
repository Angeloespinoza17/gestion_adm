...
class SyncPermissionTypeWatchersRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'watchers.*.target_type' => ['required', Rule::in(array_column(PermissionTypeWatcher::TARGET_OPTIONS, 'value'))],
